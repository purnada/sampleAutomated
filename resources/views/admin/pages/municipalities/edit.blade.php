                ...
                <form method="POST" action="{{ route('admin.municipalities.update',$municipality->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input id="title" name="title" type="text" class="my-auto ti-form-input @error('title') border-red-500 @enderror" placeholder="Title"  value="{{ old('title') ?? $municipality->title }}" />
                            @error('title')
                        ...
                        <div class="space-y-2">
                            ...
                            <input id="seo_url" name="seo_url" type="text" class="my-auto ti-form-input @error('seo_url') border-red-500 @enderror" placeholder="seo-url"  value="{{ old('seo_url') ?? $municipality->seo_url }}" />
                            @error('seo_url')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="space-y-2">
                            ...
                            <input id="meta_title" name="meta_title" type="text" class="my-auto ti-form-input @error('meta_title') border-red-500 @enderror" placeholder="Meta Title"  value="{{ old('meta_title') ?? $municipality->meta_title }}" />
                            @error('meta_title')
                                <span class=" text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="space-y-2">
                            ...
                            <input id="meta_keyword" name="meta_keyword" type="text" class="my-auto ti-form-input @error('meta_keyword') border-red-500 @enderror" placeholder="Meta Keyword"  value="{{ old('meta_keyword') ?? $municipality->meta_keyword }}" />
                            @error('meta_keyword')
                                <span class=" text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="space-y-2">
                            ...
                            <input id="meta_description" name="meta_description" type="text" class="my-auto ti-form-input @error('meta_description') border-red-500 @enderror" placeholder="Meta Description"  value="{{ old('meta_description') ?? $municipality->meta_description }}" />
                    ...
                    <textarea id="description" name="description" class="ti-form-input @error('image') border-red-500 @enderror">{{ old('description') ?? $municipality->description}}</textarea>
                            @error('description')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
