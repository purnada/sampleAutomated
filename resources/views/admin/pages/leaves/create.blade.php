    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form method="POST" action="{{ route('admin.leaves.store') }}" enctype="multipart/form-data" class="space-y-3">
                        @csrf
                        ...
                        <div class="sm:grid grid-cols-12 gap-x-6">
                            ...
                            <select class="col-span-9 ti-form-input @error('user_id') border-red-500 @enderror" name="user_id">
                                ...
                                @foreach ($users as $user)
                                    <option value="{{ $user->id }}" @selected($user->id == old('user_id'))>{{ $user->name }}
                                    </option>
                                @endforeach
                            </select>
