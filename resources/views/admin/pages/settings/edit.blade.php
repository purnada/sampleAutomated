                    ...
                    <div class="">
                        <div id="hs-tab-js-behavior-1" role="tabpanel" aria-labelledby="general">
                            ...
                            <div class="space-y-2 ">
                                ...
                                <input id="email" type="email" name="email" class="my-auto ti-form-input @error('email') border-red-500 @enderror" placeholder="email"  value="{{ old('email') ?? $setting->email }}" />
                                @error('email')
                            ...
                            <div class="space-y-2 ">
                                ...
                                <input id="latitude" type="text" name="latitude" class="my-auto ti-form-input @error('latitude') border-red-500 @enderror" placeholder="latitude"  value="{{ old('latitude') ?? $setting->latitude }}" />
                                @error('latitude')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="space-y-2 ">
                                ...
                                <input id="longitude" type="text" name="longitude" class="my-auto ti-form-input @error('longitude') border-red-500 @enderror" placeholder="longitude"  value="{{ old('longitude') ?? $setting->longitude }}" />
                                @error('longitude')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="space-y-2">
                                ...
                                @error('logo')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                                @if ($setting->logo_thumb)
                                    <img src="{{ $setting->logo_thumb }}" width="100">
                                @endif
                            </div>
                            <div class="space-y-2">
                                ...
                                @error('icon')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                                @if ($setting->icon_thumb)
                                    <img src="{{ $setting->icon_thumb }}" width="100">
                                @endif
                            </div>
                            <div class="space-y-2 ">
                            <label class="ti-form-label ">Google Analytics</label>
                            <textarea id="analytics" name="analytics" class="ti-form-input @error('image') border-red-500 @enderror">{{ old('analytics') ?? $setting->analytics }}</textarea>
                            @error('analytics')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                            </div>
                                    ...
                                    <div class="grid lg:grid-cols-2 gap-6 mt-5 ml-5">
                                        <div class="space-y-2">
                                            ...
                                            <input id="name" type="text" name="detail[{{ $language->id }}][name]"
                                                ...
                                                placeholder="name"  value="{{ old('detail.'.$language->id.'.name') ?? $language->settingDetail->name }}" />
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <input id="telephone" type="text" name="detail[{{ $language->id }}][telephone]"
                                                ...
                                                placeholder="+9779841000000"  value="{{ old('detail.'.$language->id.'.telephone') ?? $language->settingDetail->telephone }}" />
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <input id="address" type="text"
                                                ...
                                                placeholder="address"  value="{{ old('detail.'.$language->id.'.address') ?? $language->settingDetail->address }}" />
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <input id="meta_title"
                                                ...
                                                value="{{ old('detail.'.$language->id.'.meta_title') ?? $language->settingDetail->meta_title }}" />
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <input id="meta_keyword"
                                                ...
                                                value="{{ old('detail.'.$language->id.'.meta_keyword') ?? $language->settingDetail->meta_keyword }}" />
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <input id="meta_description" name="detail[{{ $language->id }}][meta_description]"
                                                ...
                                                value="{{ old('detail.'.$language->id.'.meta_description') ?? $language->settingDetail->meta_description }}" />
                            ...
                            <div class="grid lg:grid-cols-2 gap-6 mt-5">
                                <div class="space-y-2">
                                    ...
                                    <select id="protocol" class="my-auto ti-form-input @error('protocol') border-red-500 @enderror" name="protocol">
                                        ...
                                        <option value="{{ $protocol['value'] }}" @selected($protocol['value'] == $setting->settingEmail->protocol)>{{ $protocol['title'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('protocol')
                                        <span class="text-red-500 text-xs">{{ $message }}</span>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input id="parameter" type="text" name="parameter" class="my-auto ti-form-input @error('parameter') border-red-500 @enderror" placeholder="john@domain.com"  value="{{ old('parameter') ?? $setting->settingEmail->parameter }}" />
                                    @error('parameter')
                                        <span class="text-red-500 text-xs">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <input id="host_name" type="text" name="host_name" class="my-auto ti-form-input @error('host_name') border-red-500 @enderror" placeholder="smpt.google.com"  value="{{ old('host_name') ?? $setting->settingEmail->host_name }}" />
                                    @error('host_name')
                                        <span class="text-red-500 text-xs">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <input id="username" name="username" type="text" class="my-auto ti-form-input @error('username') border-red-500 @enderror" placeholder="john@domain.com"  value="{{ old('username') ?? $setting->settingEmail->username }}" />
                                    @error('username')
                                        <span class=" text-red-500 text-xs">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <input id="password" name="password" type="text" class="my-auto ti-form-input @error('password') border-red-500 @enderror" placeholder="password"  value="{{ old('password') ?? $setting->settingEmail->password }}" />
                                    @error('password')
                                        <span class=" text-red-500 text-xs">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <input id="smtp_port" name="smtp_port" type="text" class="my-auto ti-form-input @error('smtp_port') border-red-500 @enderror" placeholder="995"  value="{{ old('smtp_port') ?? $setting->settingEmail->smtp_port }}" />
                                    @error('smtp_port')
                                        <span class="text-red-500 text-xs">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <input id="encryption" name="encryption" type="text" class="my-auto ti-form-input @error('encryption') border-red-500 @enderror" placeholder="tls"  value="{{ old('encryption') ?? $setting->settingEmail->encryption }}" />
                                    @error('encryption')
                                        <span class="text-red-500 text-xs">{{ $message }}</span>
                                    @enderror
                                </div>
