    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form method="POST" id="appointment_form" action="{{ route('admin.appointments.store') }}"
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <select class="ti-form-select @error('doctor_id') border-red-500 @enderror" name="doctor_id"
                                    ...
                                    @foreach ($doctors as $doctor)
                                        <option value="{{ $doctor->id }}" @selected($doctor->id == old('doctor_id'))>{{ $doctor->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="space-y-2">
                                ...
                                <input id="appoint_date" type="text" name="nepali_date"
                                    ...
                                    placeholder="YYYY-MM-DD" value="{{ old('nepali_date') }}" />
                                @error('nepali_date')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="space-y-2">
                                ...
                                <select class="ti-form-select @error('sector') border-red-500 @enderror" name="sector"
                                    ...
                                    {!! \App\Library\UserStaticData::getDoctorSectors(old('doctor_id'), old('sector')) !!}
                                </select>
