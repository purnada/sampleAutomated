                ...
                <form method="POST" action="{{ route('admin.languages.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input id="code" type="text" name="code" class="my-auto ti-form-input @error('code') border-red-500 @enderror" placeholder="en"  value="{{ old('code') }}" />
                            @error('code')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" class="ti-switch" name="default_value" {{ old('default_value') == 'on' ? 'checked' : "" }}>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" class="ti-switch" name="status_value" {{ old('status_value') == 'on' ? 'checked' : "" }}>
