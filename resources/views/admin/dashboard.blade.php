...
@section('content')
    <div class="block justify-between page-header sm:flex">
        ...
        <ol class="flex items-center whitespace-nowrap min-w-0">
            ...
            <li class="text-sm text-gray-500 hover:text-primary dark:text-white/70" aria-current="page">Dashboard</li>
        </ol>
    </div>
    @if ($userRole != 'doctor')
        <div class="grid grid-cols-12 gap-x-5">

            <div class="col-span-6 md:col-span-3 xxl:col-span-3">
                <div class="box">
                    <div class="box-body">
                        <div class="flex">
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="flex">
                            ...
                            <div class="flex-1">
                                <p class="text-sm">Total Doctors</p>
                                <div class="flex justify-between items-center">
                                    <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">
                                        {{ $data['total_doctors'] }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="flex">
                            ...
                            <div class="flex-1">
                                <p class="text-sm">Total Agents</p>
                                <div class="flex justify-between items-center">
                                    <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">
                                        {{ $data['total_agents'] }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="flex">
                            ...
                            <div class="flex-1">
                                <p class="text-sm">Completed Appointments</p>
                                <div class="flex justify-between items-center">
                                    <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">
                                        {{ $data['completed_appointments'] }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="flex">
                            ...
                            <div class="flex-1">
                                <p class="text-sm">Arrived Appointments</p>
                                <div class="flex justify-between items-center">
                                    <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">
                                        {{ $data['arrived_appointments'] }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="flex">
                            ...
                            <div class="flex-1">
                                <p class="text-sm">Cancel Appointments</p>
                                <div class="flex justify-between items-center">
                                    <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">
                                        {{ $data['cancel_appointments'] }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-span-12">
            <div class="box">
                <div class="box-header flex justify-between">
                    <div class="box-title my-auto">Today's Appointments </div>
                                        ...
                                        <td>
                                            <div class="hs-dropdown ti-dropdown">
                                                <button id="hs-dropdown-default" type="button"
                                                    ...
                                                    Actions
                                                    <svg class="hs-dropdown-open:rotate-180 ti-dropdown-caret"
                                                    ...
                                                    @if ($appointment->status != '3')
                                                        @can('edit appointment')
                                                            <a href="{{ route('admin.appointments.edit', $appointment->id) }}"
                                                                class="ti-dropdown-item" title="Edit"><i
                                                        ...
                                                        @can('delete appointment')
                                                            <button type="button"
                                                                ...
                                                                class="ti-dropdown-item" title="Delete"><i
                                                                    class="ti ti-trash"></i>
                                                                Delete</button>
                                                        @endcan
                                                    @endif
                                                        ...
                                                        <div class="ti-modal-header">
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                <span class="sr-only">Close</span> <svg
                                                                    class="w-3.5 h-3.5" width="8" height="8"
                                                        ...
                                                        <div class="ti-modal-body">
                                                            <div class="table-bordered rounded-sm overflow-auto">
                                                                <table
                                                                    ...
                                                                    <tr>
                                                                        <td>Ward No:</td>
                                                                        <td><strong>{{ $appointment->ward_no }}</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>House No:</td>
                                                                        <td><strong>{{ $appointment->house_no }}</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Gender:</td>
                                                                        <td><strong>{{ $appointment->gender }}</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Age:</td>
                                                                        <td><strong>{{ $appointment->age }} Years</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Status:</td>
                                                                    ...
                                                                    @if ($appointment->cancel_by)
                                                                        <tr>
                                                                            <td>Cancel By:</td>
                                                                            <td><strong>{!! $appointment->cancel_by !!}</strong>
                                                                            </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if ($appointment->remarks)
                                                                        <tr>
                                                                            <td>Remarks:</td>
                                                                            <td><strong>{!! $appointment->remarks !!}</strong>
                                                                            </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if ($appointment->reschedule_type)
